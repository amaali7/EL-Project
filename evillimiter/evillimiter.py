...
InitialArguments = collections.namedtuple('InitialArguments', 'interface, gateway_ip, netmask, gateway_mac, daemon_type, limit_to')
...
def parse_arguments():
    ...
    parser.add_argument('-s', '--speed', dest='limit_to', help='flush current iptables (firewall) and tc (traffic control) settings.')
    parser.add_argument('-d', '--daemon-type', dest='daemon_type', help='Limit or Block daemon')
...
def process_arguments(args):
    ...
    return InitialArguments(interface=interface, gateway_ip=gateway_ip, gateway_mac=gateway_mac, netmask=netmask, daemon_type=demon_type, limit_to=limit_to)
